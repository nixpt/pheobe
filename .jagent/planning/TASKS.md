...
- [x] **PHEOBE-48** (`tickets/PHEOBE-48-exclude-pheobe-from-engine-commits.md`) — `.pheobe/` kept out of engine self-commits via the worktree's git exclude; forced commits named in doubts. _(foreman s463)_
