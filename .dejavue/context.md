...
- `src/worktree.rs` — provision (buckets > git worktree; inside the repo at `.jagent/worktrees/<branch>` for fleet repos, PHEOBE-51), allowlist check, pathspec commit with `Pheobe-Task:` trailer, `commits_since` base.
